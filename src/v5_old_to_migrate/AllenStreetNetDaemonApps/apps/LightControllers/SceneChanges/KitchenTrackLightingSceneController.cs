...
[NetDaemonApp]
public class KitchenTrackLightingSceneController
{
    ...
    public KitchenTrackLightingSceneController(IHaContext ha, INetDaemonScheduler scheduler, ILogger logger, IKitchenLightsWrapper kitchenLightsWrapper)
    {
        _ha = ha;
        _logger = logger;

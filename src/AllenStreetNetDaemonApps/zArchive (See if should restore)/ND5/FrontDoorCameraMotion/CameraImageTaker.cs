...
//     {
//         _logger.LogDebug("CaptureFontDoorImage last motion at: {LastMotionAt}, current time: {Now}", _lastMotionSeenAt, DateTimeOffset.Now);
//
...
//         
//         _logger.LogDebug("Saving images to: {MediaPath} and {LocalPath}", fullPathToMedia, fullPathToLocal);
//         
...
//             
//             _logger.LogInformation("Deleting old snapshot: {Path}", filePath);
...
//     {
//         _logger.LogDebug("CaptureFontDoorImageFromFarCam last motion at: {LastMotionAt}, current time: {Now}", _lastMotionSeenAt, DateTimeOffset.Now);
//
//         Directory.CreateDirectory(_cameraSnapshotsDirectory);
//
//         var fileSafeTimestamp = DateTimeOffset.Now.ToString("yyyy-MM-dd_HH-mm-ss.ff");

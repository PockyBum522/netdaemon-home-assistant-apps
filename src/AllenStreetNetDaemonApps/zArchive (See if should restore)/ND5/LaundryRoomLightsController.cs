...
//
//         _logger.LogInformation("Checking if {MinutesAgoVarName}: {MinutesAgo} is greater than LastMotionAtBackDoorAt: {LastMotionAtBackDoor}",
...
//         
//         _logger.LogInformation("Checking if longTimeAgo: {LongTimeAgo} is less than LastMotionAtBackDoorAt: {LastMotionAtBackDoor}", 

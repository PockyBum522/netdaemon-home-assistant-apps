...
public class HomeAssistantDashboardSwitchResetter
{
    ...
    public HomeAssistantDashboardSwitchResetter(ILogger logger, IHaContext ha, INetDaemonScheduler scheduler)
    {
        _logger = logger;
        _ha = ha;
    ...
    private void GetAllSwitches()
    {
        ...
        _switchesToReset.Add(_entities.Switch.DavidDesktopNonCompositeWol);

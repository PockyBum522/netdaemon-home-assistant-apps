...
[NetDaemonApp]
public class KitchenCeilingLightsSceneController
{
    ...
    public KitchenCeilingLightsSceneController(IHaContext ha, INetDaemonScheduler scheduler, ILogger logger, IKitchenLightsWrapper kitchenLightsWrapper)
    {
        _ha = ha;
        _logger = logger;

...
public class MasterBathLightsMotionController
{
    ...
    public MasterBathLightsMotionController(ILogger logger, IHaContext ha, INetDaemonScheduler scheduler, IMasterBathLightsWrapper masterBathLightsWrapper) //, ILogger logger)
    {
        //_logger = logger;
        _logger = logger;

...
public class MaxxLastPilledTracker
{
    ...
    public MaxxLastPilledTracker(IHaContext ha, INetDaemonScheduler scheduler, IKitchenLightsWrapper kitchenLightsWrapper, IFrontRoomLightsWrapper frontRoomLightsWrapper)
    {

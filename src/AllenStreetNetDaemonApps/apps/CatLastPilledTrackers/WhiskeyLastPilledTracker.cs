...
public class WhiskeyLastPilledTracker
{
    ...
    public WhiskeyLastPilledTracker(IHaContext ha, INetDaemonScheduler scheduler, IKitchenLightsWrapper kitchenLightsWrapper, IFrontRoomLightsWrapper frontRoomLightsWrapper)
    {
    ...
    private async Task HandleCatPilledButtonPress(Event e)
    {
        ...
        // {
        //     _logger.LogDebug("Double click event fired");
        // }
